    ...
    <div className="instruction container">
      ...
      <div>
        <ol className="list-group">
         ...
         <li className="list-group-item">Обери дитину зі списку.</li> 
        ...
        <li className="list-group-item">Якщо маєш намір виконати бажання, натисни на кнопку <strong>“Здійснити мрію"</strong>, заповни форму — і мрія дитини закріпиться за тобою. У формі обов'язково залиш свої дані: ПІБ або нікнейм та корпоративний e-mail для зв'язку.</li>
        <li className='list-group-item'>Ти також можеш об'єднуватися з колегами. У цьому випадку визначите координатора, який зареєструє листа дитини за своїми контактними даними.</li>
        ...
        <li className="list-group-item"> Передай подарунок до <b>HR твого офісу</b> АБО надішли його нам на поштомат Нової Пошти в офісі на Тичини:
          ...
          Подарунок необхідно надіслати <strong>до 01.12.2024</strong>
        </li>
